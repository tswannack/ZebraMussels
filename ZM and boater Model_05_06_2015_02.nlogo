...
to setup
                                     ; takes a screenshot of the view, bitmap file named Screenshot, quality of image is better this way.
 ca 
 set day 0
 set month "January"
 set year 1
...
ask patches [
count-neighbors
if number-infected? <= total-neighbor-state [set N? True set pcolor yellow]
...
;    set elevation depth-update                                                       ; this sets the imported elevation data to the patch elevation variable
;    set salinity salinity-update                                                     ; this sets the imported salinity data to the patch salinity variable
;    set TSS TSS-update                                                               ; this sets the imported TSS data to the patch TSS variable
;    set temperature Temp-update                                                      ; this sets the imported temperature data to the patch temperaturevariable
;    set DO DO-update                                                                 ; this sets the imported DO data to the patch DO variable 
; ]
...
to counter ; begin counter procedure 
  ...
  if day >= 1 and day <= 31 [set month "January"]
  if day >= 32 and day <= 59 [set month "February"]
  if day >= 60 and day <= 90 [set month "March"]
  if day >= 91 and day <= 120 [set month "April"]
  if day >= 121 and day <= 151 [set month "May"]
  if day >= 152 and day <= 181 [set month "June"]
  if day >= 182 and day <= 212 [set month "July"]
  if day >= 213 and day <= 243 [set month "August"]
  if day >= 244 and day <= 273 [set month "September"]
  if day >= 274 and day <= 304 [set month "October"]
  if day >= 305 and day <= 334 [set month "November"]
  if day >= 335 and day <= 366 [set month "December"]
