...
to update-infected-status; begin updating boat infected status
  set boat-id who
 ask boats with [pcolor = red] [set color yellow + random 2]
 ask boats with [pcolor = orange] [set color yellow + random 2]
ask boats with [pcolor != red and pcolor != orange] [set color white]
