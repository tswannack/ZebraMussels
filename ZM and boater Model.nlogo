...
ask patches [
count-neighbors
if infected-neighbors <= total-neighbor-state [set N? True set pcolor yellow]
...
192
297
K is number of neighbors that have to be yellow in order to change states
13
0.0
1
