...
extensions [ gis table array pathdir profiler ]
...
to setup
  ca
  set-global-environment         ;sets global environmental variables

  
  ask n-of 2 patches [           ;creates 2 patch environment and sets patch-level environment
    set pcolor green
...
to go
  ...
  calculate-HSI                 ;calculates HSI values per cell
